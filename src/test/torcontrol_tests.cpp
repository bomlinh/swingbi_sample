...
void CheckSplitTorReplyLine(std::string input, std::string swingbicoinnd, std::string args)
{
    BOOST_TEST_MESSAGE(std::string("CheckSplitTorReplyLine(") + input + ")");
    auto ret = SplitTorReplyLine(input);
    BOOST_CHECK_EQUAL(ret.first, swingbicoinnd);
...
BOOST_AUTO_TEST_CASE(util_SplitTorReplyLine)
{
    ...
    // Other valid inputs
    CheckSplitTorReplyLine("SWINGBICOINND", "SWINGBICOINND", "");
    CheckSplitTorReplyLine("SWINGBICOINND SOME  ARGS", "SWINGBICOINND", "SOME  ARGS");
    ...
    // between the swingbicoinnd and arguments.
    CheckSplitTorReplyLine("SWINGBICOINND  ARGS", "SWINGBICOINND", " ARGS");
    CheckSplitTorReplyLine("SWINGBICOINND   EVEN+more  ARGS", "SWINGBICOINND", "  EVEN+more  ARGS");
}
