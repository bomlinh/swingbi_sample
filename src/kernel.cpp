...
int nStakeTargetSpacing = 60; // SwingbiCoin: 1 minute blocks during POS (block 201+)
...
{
    // SwingbiCoin will hash in the transaction hash and the index number in order to make sure each hash is unique
