...
void CBudgetManager::ProcessMessage(CNode* pfrom, std::string& strSwingbiCoinnd, CDataStream& vRecv)
{
    ...
    if (strSwingbiCoinnd == "mnvs") { //Masternode vote sync
        uint256 nProp;
        vRecv >> nProp;
    ...
    if (strSwingbiCoinnd == "mprop") { //Masternode Proposal
    ...
    if (strSwingbiCoinnd == "mvote") { //Masternode Vote
        CBudgetVote vote;
        vRecv >> vote;
        vote.fValid = true;
    ...
    if (strSwingbiCoinnd == "fbs") { //Finalized Budget Suggestion
    ...
    if (strSwingbiCoinnd == "fbvote") { //Finalized Budget Vote
