...
enum RPCErrorCode {
    ...
    RPC_MISC_ERROR = -1,               //! std::exception thrown in swingbicoinnd handling
    RPC_FORBIDDEN_BY_SAFE_MODE = -2,   //! Server is in safe mode, and swingbicoinnd is not allowed in safe mode
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! SwingbiCoin is not connected
    ...
    RPC_WALLET_WRONG_ENC_STATE = -15,      //! SwingbiCoinnd given in wrong wallet encryption state (encrypting an encrypted wallet etc.)
