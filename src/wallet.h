...
public:
    ...
    bool CommitTransaction(CWalletTx& wtxNew, CReserveKey& reservekey, std::string strSwingbiCoinnd = "tx");
...
public:
    ...
    void RelayWalletTransaction(std::string strSwingbiCoinnd = "tx");
