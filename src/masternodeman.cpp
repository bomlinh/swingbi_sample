...
void CMasternodeMan::ProcessMessage(CNode* pfrom, std::string& strSwingbiCoinnd, CDataStream& vRecv)
{
    ...
    if (strSwingbiCoinnd == "mnb") { //Masternode Broadcast
    ...
    else if (strSwingbiCoinnd == "mnp") { //Masternode Ping
        CMasternodePing mnp;
        vRecv >> mnp;
    ...
    } else if (strSwingbiCoinnd == "dseg") { //Get Masternode list or specific entry
