...
void CMasternodePayments::ProcessMessageMasternodePayments(CNode* pfrom, std::string& strSwingbiCoinnd, CDataStream& vRecv)
{
    ...
    if (strSwingbiCoinnd == "mnget") { //Masternode Payments Request Sync
        if (fLiteMode) return;   //disable all Masternode related functionality
    ...
    } else if (strSwingbiCoinnd == "mnw") { //Masternode Payments Declare Winner
