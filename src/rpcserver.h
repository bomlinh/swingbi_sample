...
/**
 * SwingbiCoin RPC swingbicoinnd dispatcher.
 */
class CRPCTable
{
private:
    std::map<std::string, const CRPCSwingbiCoinnd*> mapSwingbiCoinnds;

public:
    CRPCTable();
    const CRPCSwingbiCoinnd* operator[](std::string name) const;
    ...
    /**
    * Returns a list of registered swingbicoinnds
    * @returns List of registered swingbicoinnds.
    */
    std::vector<std::string> listSwingbiCoinnds() const;
};
