...
// Copyright (c) 2015-2018 The SWINGBICOIN developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SWINGBICOIN Core") + " - ";
#ifdef ENABLE_WALLET
   ...
   // progressBorder = new QLabel();
   // progressBorder->setVisible(true);
    //progressBorder->setObjectName("progressBorder");
   ...
   // statusBar()->addWidget(progressBorder);
    ...
    // Get restart swingbicoinnd-line parameters and handle restart
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SWINGBICOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and swingbicoin: URIs)"));
   ...
   // privacyAction->setStatusTip(tr("Privacy Actions for zSWBI"));
  ...
  //  governanceAction->setCheckable(true);
   ...
   // connect(governanceAction, SIGNAL(triggered()), this, SLOT(gotoGovernancePage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SWINGBICOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about SWINGBICOIN Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for SWINGBICOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SWINGBICOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SWINGBICOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a SWINGBICOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&SwingbiCoinnd-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SWINGBICOIN Core help message to get a list with possible SWINGBICOIN swingbicoinnd-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SWINGBICOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SWINGBICOIN network", "", count));
}
...
{
    QString strTitle = tr("SWINGBICOIN Core"); // default title
...
/** Get restart swingbicoinnd-line parameters and request restart */
