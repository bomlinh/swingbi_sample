...
bool Intro::pickDataDirectory()
{
    namespace fs = boost::filesystem;
    QSettings settings;
    /* If data directory provided on swingbicoinnd line, no need to look at settings
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SwingbiCoin Core"),
     ...
     * override -datadir in the swingbicoin.conf file in the default data directory
     * (to be consistent with swingbicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
