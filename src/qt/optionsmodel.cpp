...
{
    strOverriddenBySwingbiCoinndLine += QString::fromStdString(option) + "=" + QString::fromStdString(mapArgs[option]) + " ";
}
...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SWBI);
    ...
    // These are shared with the core or have a swingbicoinnd-line parameter
    // and we want swingbicoinnd-line parameters to overwrite the GUI settings.
    //
    // If setting doesn't exist create it with defaults.
    //
    // If SoftSetArg() or SoftSetBoolArg() return false we were overridden
    // by swingbicoinnd-line and show this in the UI.
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in swingbicoin.cpp during shotdown to also remove the window positions
