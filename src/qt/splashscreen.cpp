...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("SwingbiCoin Core");
    ...
    QString copyrightTextSWBI = QChar(0xA9) + QString("").arg(COPYRIGHT_YEAR) + QString(tr(" 2019 The SwingbiCoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextSWBI);
