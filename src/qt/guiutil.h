...
/** Utility functions used by the SwingbiCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SWBI addresses in monospace font
...
// Parse "swingbicoin:" URI into recipient object, return true on successful parsing
...
/** Get save filename, mimics QFileDialog::getSaveFileName, except that it appends a default suffix
      ...
      @param[in] filter  Filter specification such as "SwingbiCoin Separated Files (*.csv)"
