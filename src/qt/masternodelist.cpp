...
void MasternodeList::StartAll(std::string strSwingbiCoinnd)
{
    ...
    BOOST_FOREACH (CMasternodeConfig::CMasternodeEntry mne, masternodeConfig.getEntries()) {
        ...
        if (strSwingbiCoinnd == "start-missing" && pmn) continue;
...
void MasternodeList::on_startMissingButton_clicked()
{
    if (!masternodeSync.IsMasternodeListSynced()) {
        QMessageBox::critical(this, tr("SwingbiCoinnd is not available right now"),
            tr("You can't use this swingbicoinnd until masternode list is synced"));
        return;
    }
