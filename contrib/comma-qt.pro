...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/swingbicoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/swingbicoin-cli.cpp \
           src/swingbicoin-tx.cpp \
           src/swingbicoin.cpp \
           src/db.cpp \
           ...
           src/qt/swingbicoin.cpp \
           src/qt/swingbicoinstrings.cpp \
...
RESOURCES += src/qt/swingbicoin.qrc src/qt/swingbicoin_locale.qrc

TRANSLATIONS += src/qt/locale/swingbicoin_bg.ts \
                src/qt/locale/swingbicoin_de.ts \
                src/qt/locale/swingbicoin_en.ts \
                src/qt/locale/swingbicoin_es.ts \
                src/qt/locale/swingbicoin_fi.ts \
                src/qt/locale/swingbicoin_fr.ts \
                src/qt/locale/swingbicoin_it.ts \
                src/qt/locale/swingbicoin_ja.ts \
                src/qt/locale/swingbicoin_pl.ts \
                src/qt/locale/swingbicoin_pt.ts \
                src/qt/locale/swingbicoin_ru.ts \
                src/qt/locale/swingbicoin_sk.ts \
                src/qt/locale/swingbicoin_sv.ts \
                src/qt/locale/swingbicoin_vi.ts \
                src/qt/locale/swingbicoin_zh_CN.ts \
                src/qt/locale/swingbicoin_zh_TW.ts
