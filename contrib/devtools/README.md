...
Check if all swingbicoinnd line args are documented. The return value indicates the
...
swingbicoin/swingbicoin repository.
...
Setup
---------
Configuring the github-merge tool for the SwingbiCoin repository is done in the following way:

    git config githubmerge.repository swingbicoin/swingbicoin
...
A script to optimize png files in the SwingbiCoin
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_swingbicoin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_swingbicoin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_swingbicoin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_swingbicoin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
