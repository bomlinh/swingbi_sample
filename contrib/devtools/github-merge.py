...
def main():
    ...
    if repo is None:
        print("ERROR: No repository configured. Use this swingbicoinnd to set:", file=stderr)
    ...
    # Extract settings from swingbicoinnd line
    ...
    try:
        ...
        # Run test swingbicoinnd if configured.
        if testcmd:
