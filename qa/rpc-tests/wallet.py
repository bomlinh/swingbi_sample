...
#   c) node1 mines 32 blocks, so now node 0 has 500000SWBI, node 1 has 4250SWBI, node2 has none.
#   d) node0 sends 601 SWBI to node2, in two transactions (301 SWBI, then 300 SWBI).
