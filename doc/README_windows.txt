...
Intro
-----
SwingbiCoin (SWBI) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. SwingbiCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run swingbicoin-qt.exe.

SwingbiCoin Core is the original SwingbiCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of SwingbiCoin transactions;
