...
In order to support loading of multiple wallets in swingbicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is swingbicoin.cpp.
...
Changes to swingbicoin.cpp
----------------------
swingbicoin.cpp is the entry point into swingbicoin-qt, and as such, will require some minor modifications to provide hooks for
