Contributing to SwingbiCoin Core
==================================

The SwingbiCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SwingbiCoin Core project, and is not to be
confused with overall SwingbiCoin Network Protocol consensus changes.

Whether a pull request is merged into SwingbiCoin Core rests with the project merge
...
Patches that change SwingbiCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SwingbiCoin consensus, it must have been
...
The project leader is the release manager for each SwingbiCoin Core release.
